    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url({{ asset(theme()->getMediaUrlPath() . 'misc/auth-bg.png') }})">
                <!--begin::Content-->
                <div class="d-flex flex-column flex-center py-15 px-5 px-md-15 w-100 text-center">
                    <!--begin::Logo-->
                    <a href="/" class="p-12"> 
                        <img alt="Logo" src="{{ asset(theme()->getMediaUrlPath() . 'logos/logo.svg') }}" class="h-75px login-logo">
                    </a>
                    <!--end::Logo-->
                    <!--begin::Image-->
                    ...
                    <!--end::Image-->
                    <!--begin::Title-->
                    {{-- <h1 class="text-white fs-2qx fw-bolder text-center mb-7"></h1> --}}
                    <!--end::Title-->
                    <!--begin::Text-->
