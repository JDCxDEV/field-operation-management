...
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    ...
    <div class="card-header cursor-pointer">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">{{ __('') }}</h3>
        </div>
        <!--end::Card title-->

        <!--begin::Action-->
        <a href="{{ theme()->getPageUrl($isAuth ? 'account/settings' : ('account/settings?user_id='. $user->id) ) }}" class="btn btn-primary align-self-center">{{ __('Edit Profile') }}</a>
        <!--end::Action-->
    </div>
    <!--begin::Card header-->
    ...
    <div class="card-body p-9">
        ...
        <div class="row mb-7">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">{{ __('Market') }}</label>
            <!--end::Label-->

            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
                <span class="fw-bold fs-6">{{ $info->market_name ?? '—' }}</span>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
