            ...
            <div class="card-body border-top p-9">
                ...
                <div class="d-flex flex-wrap align-items-center">
                    ...
                    <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                        <!--begin::Form-->
                        <form id="kt_signin_change_email" class="form" novalidate="novalidate" method="POST" action="{{ route('settings.changeEmail', $user->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="d-flex">
                                <button class="btn btn-primary  me-2 px-6">
                ...
                <div class="d-flex flex-wrap align-items-center mb-10">
                    ...
                    <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                        <!--begin::Form-->
                        <form id="kt_signin_change_password" class="form" novalidate="novalidate" method="POST" action="{{ route('settings.changePassword', $user->id) }}">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="current_email" value="{{ $user->email }} "/>
                            <div class="row mb-1">
