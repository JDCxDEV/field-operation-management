...
<body 
id="app"
{!! theme()->printHtmlAttributes('body') !!} {!! theme()->printHtmlClasses('body') !!} {!! theme()->printCssVariables('body') !!} data-kt-name="metronic">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDLqOLDTePiZXZ_bosn1mQDUfBx1y9f8rI&libraries=places&callback=gmapcallback"></script>
