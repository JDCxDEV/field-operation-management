...
export default {
  ...
  methods: {
     ...
     * @param boolean fade
     **/
    parseError(error, title = null, options = {}, displayError = true) {
      options.fade = false;
      return this.parseResponse(error, 'error', title, options, displayError);
    },
     ...
     * @return string
     */
    parseResponse(result, type, title = null, options = {}, displayError = true) {
